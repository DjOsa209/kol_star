...
项目概览汇总内容、合作资源、曝光互动、成本效率与平台表现：

![项目概览：内容与合作资源、曝光互动、付费 KOL 成本及平台表现](./docs/screenshots/project-overview.png)

项目详情的达人/媒体页展示合作资源、粉丝量、内容数量、曝光、互动与 CPM：

![项目详情：达人与媒体](./docs/screenshots/project-creators.png)

项目详情的内容页（关联社媒发布作品与内容表现）：

![项目详情：合作内容卡片](./docs/screenshots/project-content.png)
...
![全球资源库：资源身份、平台表现、合作数据与近期作品](./docs/screenshots/resource-library.png)

资源档案展示单个创作者的平台指标与近期作品：

![全球资源库：gregglestv 达人档案](./docs/screenshots/resource-profile.png)
...
![首页仪表盘：全球 KOL 营销驾驶舱](./docs/screenshots/dashboard.png)
...
以上六张截图由项目方提供，仅代表拍摄时的界面状态，包含项目名称、创作者公开资料、运营指标、付费 KOL 成本及部分 CPM/CPE。本文未展示联系人、凭证、单人合同价格或完整预算；更完整的业务数据应在经授权的环境查看。
